...
function DashboardShell({ children }: DashboardShellProps) {
  ...
  return (
    <div className="hidden-scrollbar relative flex min-h-screen overflow-x-hidden bg-[#050816] text-white">
      ...
      <div className="relative z-10 flex-1 md:pl-72">
        ...
        <main className="hidden-scrollbar relative min-h-[calc(100vh-80px)]">{children}</main>
      </div>
    </div>
  );
}
