...
function StatCard({ label, value, description, accent = "violet" }: StatCardProps) {
  return (
    <motion.div whileHover={{ y: -4, scale: 1.01 }} transition={{ type: "spring", stiffness: 240, damping: 20 }}>
      <Card className="relative overflow-hidden border-white/10 bg-white/6">
